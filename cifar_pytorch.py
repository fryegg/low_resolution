...
#for param in resnet.parameters():#print(param.requires_grad)
...
step_lr_scehduler = lr_scheduler.MultiStepLR(optimizer,milestones=decay_epoch,gamma=0.1)
